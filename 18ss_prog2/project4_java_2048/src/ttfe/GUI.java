...
/**
 * ==================================== NOTE
 * ================================================ This class is not covered by
 * our tests and you do not need to understand the code in here. It is merely a
 * help from our side to ease your work on the simulator and computer player.
 * ==================================== NOTE
 * ================================================
 */
public class GUI implements UserInterface {
	 ...
	 *
	 * The smaller this value is the faster the game can become if arrow keys are
	 * pressed "constantly" or a computer player is used to choose the move
	 * direction.
	 */
	 ...
	 */
	private final Color TileColors[] = { EMPTY_TILE_COLOR, new Color(205, 192, 180), new Color(238, 228, 218),
			...
			new Color(237, 197, 63), new Color(237, 194, 46), Color.BLACK, Color.BLACK, Color.BLACK, Color.BLACK,
	 ...
	 */
	private final Font TileFonts[] = { new Font("", Font.BOLD, 48), new Font("", Font.BOLD, 48),
			new Font("", Font.BOLD, 44), new Font("", Font.BOLD, 40), new Font("", Font.BOLD, 36) };
	...
	private void initialize(SimulatorInterface game) {
		...
		// Finally, set some default options and pack the window so the content will
		// appear.
		frame.pack();
	...
	public void showGameOverScreen(SimulatorInterface Game) {
		JOptionPane.showMessageDialog(frame,
				"Game Over, after " + Game.getNumMoves() + " moves and with " + Game.getPoints() + " points!",
