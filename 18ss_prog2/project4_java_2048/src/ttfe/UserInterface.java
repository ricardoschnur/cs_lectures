...
public interface UserInterface {
	 ...
	 *
	 * @param question
	 *            The question the user is supposed to answer.
	...
	/**
	 * Show a "Game Over" screen to the user including the final score and the
	 * number of moves performed.
	 *
	 * @param game
	 *            The current TTFE game instance.
	 */
	 ...
	 *
	 * @param msg
	 *            The message the user should see.
	 */
