...
public void testSmallRouting2RandomNodes() {
    ...
    checkRoute(r3a, 6619.746445988014, 415795050l, 470283288l);
}
...
public void testSmallRouting5RandomNodes() {
    ...
    checkRoute(r3a, 8057.229130524495, 1392066844l, 1123424747l);
}
...
public void testSmallRouting8RandomNodes() {
    ...
    checkRoute(r3a, 6997.445599938465, 1267452614l, 2199186783l);
}
...
public void testSmallRouting11RandomNodes() {
    ...
    checkRoute(r3a, 3598.161461538797, 2027712856l, 773561691l);
}
...
public void testSmallRouting12RandomNodes() {
    ...
    checkRoute(r3a, 8218.75792850071, 1426027517l, 1559582642l);
}
...
public void testSmallRouting18RandomNodes() {
    ...
    checkRoute(r2a, 3390.2494098729107, 287875674l, 271054647l);
    Route r3a = computeRoute(287875674l, 271054647l, TravelType.ANY, true);
    checkRoute(r3a, 3390.2494098729107, 287875674l, 271054647l);
}
...
public void testSmallRouting20RandomNodes() {
    ...
    checkRoute(r1a, 10179.48391754792, 1551970936l, 295052830l);
...
public void testSmallRouting24RandomNodes() {
    ...
    checkRoute(r2a, 3723.6999583093034, 2580511976l, 1551953946l);
    Route r3a = computeRoute(2580511976l, 1551953946l, TravelType.ANY, true);
    checkRoute(r3a, 3723.6999583093034, 2580511976l, 1551953946l);
}
...
public void testSmallRouting43RandomNodes() {
    ...
    checkRoute(r2a, 5320.131804321255, 1390041163l, 1324607749l);
    Route r3a = computeRoute(1390041163l, 1324607749l, TravelType.ANY, true);
    checkRoute(r3a, 5320.131804321255, 1390041163l, 1324607749l);
}
...
public void testSmallRouting55RandomNodes() {
    ...
    checkRoute(r2a, 2746.4531283604347, 2282845151l, 2134764319l);
    Route r3a = computeRoute(2282845151l, 2134764319l, TravelType.ANY, true);
    checkRoute(r3a, 2746.4531283604347, 2282845151l, 2134764319l);
}
...
public void testSmallRouting57RandomNodes() {
    ...
    checkRoute(r1a, 7232.7903921885245, 3455247902l, 363225786l);
    ...
    checkRoute(r3a, 7219.006713074536, 3455247902l, 363225786l);
}
...
public void testSmallRouting76RandomNodes() {
    ...
    checkRoute(r3a, 11478.902976476884, 316522222l, 1023360795l);
}
...
public void testSmallRouting79RandomNodes() {
    ...
    checkRoute(r3a, 8803.123518837176, 317992440l, 1389391043l);
}
...
public void testSmallRouting105RandomNodes() {
    ...
    checkRoute(r2a, 6242.640509213626, 618927463l, 119368728l);
    Route r3a = computeRoute(618927463l, 119368728l, TravelType.ANY, true);
    checkRoute(r3a, 6242.640509213626, 618927463l, 119368728l);
}
...
public void testSmallRouting107RandomNodes() {
    ...
    checkRoute(r2a, 1894.9906539991193, 1911438497l, 419241346l);
    Route r3a = computeRoute(1911438497l, 419241346l, TravelType.ANY, true);
    checkRoute(r3a, 1894.9906539991193, 1911438497l, 419241346l);
}
...
public void testSmallRouting116RandomNodes() {
    ...
    checkRoute(r2a, 6320.756697237626, 2134677083l, 823700230l);
    Route r3a = computeRoute(2134677083l, 823700230l, TravelType.ANY, true);
    checkRoute(r3a, 6320.756697237626, 2134677083l, 823700230l);
}
...
public void testSmallRouting120RandomNodes() {
    ...
    checkRoute(r3a, 4137.882812871631, 2270441168l, 2278352393l);
}
...
public void testSmallRouting125RandomNodes() {
    ...
    checkRoute(r3a, 11143.9562334713, 411285915l, 277448734l);
}
