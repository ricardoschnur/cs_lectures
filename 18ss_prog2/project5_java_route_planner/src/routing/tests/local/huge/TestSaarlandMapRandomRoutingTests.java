...
public void testRouting2RandomNodes() {
    ...
    checkRoute(r0a, 18296.941299045273, 504466758l, 2448171502l);
    ...
    checkWaypoints(r0b, 18296.941299045273, waypoints);
...
public void testRouting3RandomNodes() {
    ...
    checkRoute(r2a, 49855.301675975235, 763399059l, 254400425l);
    Route r3a = computeRoute(763399059l, 254400425l, TravelType.ANY, true);
    checkRoute(r3a, 49855.301675975235, 763399059l, 254400425l);
    Route r0b = computeRoute(waypointsList, TravelType.BIKE, true);
    ...
    checkWaypoints(r3b, 52254.95429830215, waypoints);
}
...
public void testRouting5RandomNodes() {
    ...
    checkWaypoints(r3b, 115761.87281505571, waypoints);
}
...
public void testRouting6RandomNodes() {
    ...
    checkWaypoints(r0b, 104933.64587168157, waypoints);
    computeRoute(waypointsList, TravelType.CAR, false);
    Route r2b = computeRoute(waypointsList, TravelType.FOOT, true);
    assertEquals("Route did not have waypoints many legs", r2b.size(), 5);
    checkWaypoints(r2b, 99262.24426273926, waypoints);
    Route r3b = computeRoute(waypointsList, TravelType.ANY, true);
    assertEquals("Route did not have waypoints many legs", r3b.size(), 5);
    checkWaypoints(r3b, 99088.7600380813, waypoints);
}
...
public void testRouting7RandomNodes() {
    ...
    checkWaypoints(r2b, 157922.38690609662, waypoints);
    Route r3b = computeRoute(waypointsList, TravelType.ANY, true);
...
public void testRouting8RandomNodes() {
    ...
    checkWaypoints(r0b, 190700.12454922928, waypoints);
    computeRoute(waypointsList, TravelType.CAR, false);
    Route r2b = computeRoute(waypointsList, TravelType.FOOT, true);
    assertEquals("Route did not have waypoints many legs", r2b.size(), 7);
    checkWaypoints(r2b, 185626.9282899289, waypoints);
    Route r3b = computeRoute(waypointsList, TravelType.ANY, true);
    assertEquals("Route did not have waypoints many legs", r3b.size(), 7);
    checkWaypoints(r3b, 182922.92584141018, waypoints);
}
...
public void testRouting9RandomNodes() {
    ...
    checkRoute(r2a, 67161.56374180017, 1597598064l, 667001478l);
    Route r3a = computeRoute(1597598064l, 667001478l, TravelType.ANY, true);
    checkRoute(r3a, 66726.00588179969, 1597598064l, 667001478l);
    computeRoute(waypointsList, TravelType.BIKE, false);
    computeRoute(waypointsList, TravelType.CAR, false);
    computeRoute(waypointsList, TravelType.FOOT, false);
    Route r3b = computeRoute(waypointsList, TravelType.ANY, true);
...
public void testRouting11RandomNodes() {
    ...
    checkRoute(r0a, 22674.798677737796, 291866472l, 366889919l);
...
public void testRouting12RandomNodes() {
    ...
    checkRoute(r0a, 56747.58092705819, 485921203l, 506698216l);
    ...
    checkWaypoints(r2b, 448130.5190617901, waypoints);
    Route r3b = computeRoute(waypointsList, TravelType.ANY, true);
    assertEquals("Route did not have waypoints many legs", r3b.size(), 11);
    checkWaypoints(r3b, 446104.8347085254, waypoints);
}
...
public void testRouting13RandomNodes() {
    ...
    checkWaypoints(r2b, 481039.5360843182, waypoints);
    Route r3b = computeRoute(waypointsList, TravelType.ANY, true);
    assertEquals("Route did not have waypoints many legs", r3b.size(), 12);
    checkWaypoints(r3b, 480130.60823487584, waypoints);
}
...
public void testRouting15RandomNodes() {
    ...
    checkWaypoints(r2b, 467047.17256754014, waypoints);
    Route r3b = computeRoute(waypointsList, TravelType.ANY, true);
    assertEquals("Route did not have waypoints many legs", r3b.size(), 14);
    checkWaypoints(r3b, 465765.85491156933, waypoints);
}
...
public void testRouting16RandomNodes() {
    ...
    checkWaypoints(r0b, 508544.53324865334, waypoints);
    computeRoute(waypointsList, TravelType.CAR, false);
    Route r2b = computeRoute(waypointsList, TravelType.FOOT, true);
    assertEquals("Route did not have waypoints many legs", r2b.size(), 15);
    checkWaypoints(r2b, 488162.59615502233, waypoints);
    Route r3b = computeRoute(waypointsList, TravelType.ANY, true);
    assertEquals("Route did not have waypoints many legs", r3b.size(), 15);
    checkWaypoints(r3b, 486433.7558507645, waypoints);
}
...
public void testRouting20RandomNodes() {
    ...
    checkWaypoints(r2b, 591887.6224210603, waypoints);
    Route r3b = computeRoute(waypointsList, TravelType.ANY, true);
...
public void testRouting21RandomNodes() {
    ...
    checkWaypoints(r3b, 729504.7043381479, waypoints);
}
...
public void testRouting22RandomNodes() {
    ...
    checkWaypoints(r3b, 754995.5005548984, waypoints);
}
...
public void testRouting23RandomNodes() {
    ...
    checkWaypoints(r2b, 587945.0206129891, waypoints);
    Route r3b = computeRoute(waypointsList, TravelType.ANY, true);
    assertEquals("Route did not have waypoints many legs", r3b.size(), 22);
    checkWaypoints(r3b, 586780.5553651424, waypoints);
}
...
public void testRouting24RandomNodes() {
    ...
    checkWaypoints(r3b, 742034.7296999418, waypoints);
}
...
public void testRouting25RandomNodes() {
    ...
    checkWaypoints(r3b, 723386.3533085671, waypoints);
}
...
public void testRouting26RandomNodes() {
    ...
    checkWaypoints(r3b, 757587.5733558313, waypoints);
}
...
public void testRouting27RandomNodes() {
    ...
    checkRoute(r0a, 48945.19767684597, 292087423l, 1430019803l);
    ...
    checkWaypoints(r3b, 763848.6196308007, waypoints);
}
...
public void testRouting28RandomNodes() {
    ...
    checkWaypoints(r3b, 947015.375298173, waypoints);
}
...
public void testRouting29RandomNodes() {
    ...
    checkWaypoints(r3b, 888082.36070979, waypoints);
}
...
public void testRouting30RandomNodes() {
    ...
    checkRoute(r2a, 12934.134519040635, 3306483512l, 354472014l);
    ...
    checkWaypoints(r2b, 706839.3179427062, waypoints);
    Route r3b = computeRoute(waypointsList, TravelType.ANY, true);
...
public void testRouting31RandomNodes() {
    ...
    checkWaypoints(r2b, 890006.4963345424, waypoints);
    Route r3b = computeRoute(waypointsList, TravelType.ANY, true);
    assertEquals("Route did not have waypoints many legs", r3b.size(), 30);
    checkWaypoints(r3b, 888293.5825803232, waypoints);
}
