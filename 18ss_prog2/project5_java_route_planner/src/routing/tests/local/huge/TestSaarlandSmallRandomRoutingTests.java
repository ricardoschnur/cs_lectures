...
public void testSmallRouting0RandomNodes() {
    ...
    checkRoute(r3a, 16972.596930518957, 1544835161l, 1219490209l);
}
...
public void testSmallRouting6RandomNodes() {
    ...
    checkRoute(r1a, 39103.5440821723, 264132126l, 2470337905l);
...
public void testSmallRouting10RandomNodes() {
    ...
    checkRoute(r2a, 48296.88457142495, 432627420l, 1209314509l);
    Route r3a = computeRoute(432627420l, 1209314509l, TravelType.ANY, true);
    checkRoute(r3a, 48044.4075433183, 432627420l, 1209314509l);
}
...
public void testSmallRouting15RandomNodes() {
    ...
    checkRoute(r0a, 53550.61809349262, 313201120l, 270110241l);
    Route r1a = computeRoute(313201120l, 270110241l, TravelType.CAR, true);
    checkRoute(r1a, 54655.88895056733, 313201120l, 270110241l);
...
public void testSmallRouting17RandomNodes() {
    ...
    checkRoute(r3a, 16745.748822872985, 648369055l, 1219490209l);
}
...
public void testSmallRouting20RandomNodes() {
    ...
    checkRoute(r0a, 51572.16563057113, 765816274l, 291310120l);
...
public void testSmallRouting22RandomNodes() {
    ...
    checkRoute(r0a, 53711.737457164214, 271045378l, 2409210584l);
    ...
    checkRoute(r2a, 53694.687369533414, 271045378l, 2409210584l);
    Route r3a = computeRoute(271045378l, 2409210584l, TravelType.ANY, true);
    checkRoute(r3a, 52877.60681865309, 271045378l, 2409210584l);
}
...
public void testSmallRouting24RandomNodes() {
    ...
    checkRoute(r0a, 15807.435989682535, 300902782l, 278943009l);
    Route r1a = computeRoute(300902782l, 278943009l, TravelType.CAR, true);
    checkRoute(r1a, 16225.12899809678, 300902782l, 278943009l);
    Route r2a = computeRoute(300902782l, 278943009l, TravelType.FOOT, true);
    checkRoute(r2a, 15467.337221998447, 300902782l, 278943009l);
    Route r3a = computeRoute(300902782l, 278943009l, TravelType.ANY, true);
    checkRoute(r3a, 15467.337221998447, 300902782l, 278943009l);
}
...
public void testSmallRouting34RandomNodes() {
    ...
    checkRoute(r3a, 56578.66422027988, 311767138l, 3449099723l);
}
...
public void testSmallRouting40RandomNodes() {
    ...
    checkRoute(r2a, 53769.73998060431, 2275837226l, 685514095l);
    Route r3a = computeRoute(2275837226l, 685514095l, TravelType.ANY, true);
    checkRoute(r3a, 53675.020698819724, 2275837226l, 685514095l);
}
...
public void testSmallRouting47RandomNodes() {
    ...
    checkRoute(r3a, 53286.309768232815, 319443832l, 672706542l);
}
...
public void testSmallRouting51RandomNodes() {
    ...
    checkRoute(r0a, 33410.8661970141, 1534030583l, 731504032l);
...
public void testSmallRouting60RandomNodes() {
    ...
    checkRoute(r2a, 53687.713854363574, 252789322l, 266382312l);
    Route r3a = computeRoute(252789322l, 266382312l, TravelType.ANY, true);
    checkRoute(r3a, 53683.645637306436, 252789322l, 266382312l);
}
...
public void testSmallRouting63RandomNodes() {
    ...
    checkRoute(r0a, 53570.41130578278, 291588043l, 893294102l);
...
public void testSmallRouting77RandomNodes() {
    ...
    checkRoute(r2a, 35852.29483776136, 2075831320l, 472295057l);
    Route r3a = computeRoute(2075831320l, 472295057l, TravelType.ANY, true);
    checkRoute(r3a, 35852.29483776136, 2075831320l, 472295057l);
}
...
public void testSmallRouting82RandomNodes() {
    ...
    checkRoute(r1a, 38363.37559621475, 2964197479l, 322824571l);
...
public void testSmallRouting83RandomNodes() {
    ...
    checkRoute(r0a, 38908.00534751039, 457131094l, 363225819l);
...
public void testSmallRouting84RandomNodes() {
    ...
    checkRoute(r2a, 36520.473220767366, 2203039756l, 2327475304l);
...
public void testSmallRouting95RandomNodes() {
    ...
    checkRoute(r0a, 27843.27265661971, 2451677169l, 432643020l);
    ...
    checkRoute(r2a, 27543.584503160997, 2451677169l, 432643020l);
...
public void testSmallRouting98RandomNodes() {
    ...
    checkRoute(r0a, 58801.76571103524, 3479463169l, 423791282l);
    Route r1a = computeRoute(3479463169l, 423791282l, TravelType.CAR, true);
    checkRoute(r1a, 61402.78075902103, 3479463169l, 423791282l);
...
public void testSmallRouting105RandomNodes() {
    ...
    checkRoute(r2a, 27544.86206012601, 361508539l, 2435600777l);
    Route r3a = computeRoute(361508539l, 2435600777l, TravelType.ANY, true);
    checkRoute(r3a, 27544.86206012601, 361508539l, 2435600777l);
}
...
public void testSmallRouting107RandomNodes() {
    ...
    checkRoute(r0a, 50742.626440134154, 756655877l, 972540225l);
...
public void testSmallRouting110RandomNodes() {
    ...
    checkRoute(r0a, 19472.17144234129, 2324398149l, 440648906l);
    ...
    checkRoute(r2a, 19108.00817600647, 2324398149l, 440648906l);
    Route r3a = computeRoute(2324398149l, 440648906l, TravelType.ANY, true);
    checkRoute(r3a, 18975.96249427285, 2324398149l, 440648906l);
}
...
public void testSmallRouting111RandomNodes() {
    ...
    checkRoute(r0a, 30120.81768777349, 917595222l, 662943609l);
...
public void testSmallRouting112RandomNodes() {
    ...
    checkRoute(r1a, 34372.84848085029, 359626068l, 336144767l);
    Route r2a = computeRoute(359626068l, 336144767l, TravelType.FOOT, true);
    checkRoute(r2a, 33795.4560928529, 359626068l, 336144767l);
    Route r3a = computeRoute(359626068l, 336144767l, TravelType.ANY, true);
    checkRoute(r3a, 33795.4560928529, 359626068l, 336144767l);
}
...
public void testSmallRouting116RandomNodes() {
    ...
    checkRoute(r2a, 37311.628286739455, 2657225438l, 339166238l);
    Route r3a = computeRoute(2657225438l, 339166238l, TravelType.ANY, true);
    checkRoute(r3a, 37311.628286739455, 2657225438l, 339166238l);
}
...
public void testSmallRouting120RandomNodes() {
    ...
    checkRoute(r0a, 45954.98200730516, 427009896l, 815293542l);
...
public void testSmallRouting122RandomNodes() {
    ...
    checkRoute(r0a, 31626.974094798155, 539398236l, 359160182l);
...
public void testSmallRouting127RandomNodes() {
    ...
    checkRoute(r3a, 27557.68402388803, 1765141941l, 281384860l);
}
